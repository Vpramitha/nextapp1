    ...
    >
      <div className="container mx-auto lg:max-w-screen-xl px-4">
        <div className="grid grid-cols-12">
          <motion.div {...leftAnimation} className="lg:col-span-5 col-span-12">
            <div className="flex gap-6 items-center lg:justify-start justify-center mb-5 mt-24">
              ...
              <p className="text-white sm:text-28 text-18 mb-0">
                In the digital <span className="text-primary">Era</span>
              </p>
            </div>
            <h1 className="font-medium lg:text-76 md:text-70 text-54 lg:text-start text-center text-white mb-10">
              Build. Launch.  <span className="text-primary">Shine </span> Online {" "}
              <span className="text-primary">With Us</span>!
            </h1>
            <div className="flex items-center md:justify-start justify-center gap-8 pb-10">
              <button
          ...
          >
            <div className="ml-20 -mr-64 pr-10 mr-2 mt-10">
              <Image
                src= {`${getImagePrefix()}images/hero/development.png`}
                alt="Banner"
                width={1050}
                height={1050}
              />
