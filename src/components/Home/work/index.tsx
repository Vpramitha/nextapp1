        ...
        <div ref={ref} className="grid grid-cols-12 items-center">
          ...
          >
            ...
            <h2 className="sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium">
              We don't just build websites—we grow your digital ecosystem with precision engineering and natural elegance.
            </h2>
          ...
          <motion.div {...TopAnimation} className="lg:col-span-5 col-span-12">
            <div className="2xl:-mr-40 mt-9 flex justify-center">
              <Image
                src= {`${getImagePrefix()}images/work/service.png`}
                alt="image"
                width={600}
                height={425}
                className="lg:w-full"
